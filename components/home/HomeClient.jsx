...
export default function HomeClient({ homeData, contactData }) {
  ...
  return (
    <>
      ...
      <JustSpaceyTitle
        justSpaceyData={homeData.justSpacey}
        carouselData={homeData.carousel}
      />
      <WhatIsAtTheHelm whatsAtTheHelmData={homeData.whatsAtTheHelm} />
      <WhosRunningTheShip whosRunningTheShip={homeData.whosRunningTheShip} />
